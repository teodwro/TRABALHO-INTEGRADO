...
<body>
    ...
    <form action="salvarRepresentante.php" method="POST">
        <input type="hidden" name="id" value="<?php echo $representante->getIdRepresentante(); ?>">
        ...
        <input type="text" name="cpf_representante" value="<?php echo $representante->getCpfRepresentante(); ?>" placeholder="CPF do Representante:" required> <br>
        <input type="text" name="rg_representante" value="<?php echo $representante->getRgRepresentante(); ?>" placeholder="RG do Representante:" required> <br>
