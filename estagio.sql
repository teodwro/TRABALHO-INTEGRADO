...
--
-- Host: 127.0.0.1
-- Tempo de geração: 12/12/2024 às 04:44
...
(9, 'ytrrrrrrrrr', 'rytttttttttt', '4765467467', '746467#@a', '365356', 10);
...
CREATE TABLE `estagios` (
  ...
  `id_professor_coorientador` int(11) NOT NULL,
  `id_empresa_estagio` int(11) NOT NULL,
  `encaminhamentos_secoes_estagio` varchar(255) DEFAULT NULL,
  ...
  `telefone_supervisor_empresa` varchar(20) DEFAULT NULL,
...
INSERT INTO `estagios` (`id_estagio`, `id_estudante`, `id_curso_estagio`, `id_professor_orientador`, `id_professor_coorientador`, `id_empresa_estagio`, `encaminhamentos_secoes_estagio`, `plano_atividades`, `relatorio_final`, `ficha_autoavaliacao`, `ficha_avaliacao_empresa`, `termo_compromisso`, `supervisor_empresa`, `cargo_formacao_supervisor`, `telefone_supervisor_empresa`, `email_supervisor_empresa`, `numero_convenio`, `tipo_processo`, `status_processo`, `periodo_estagio_inicio`, `periodo_estagio_fim`, `carga_horaria`) VALUES
(32, 5, 10, 2, 2, 9, 'PIROQUINHA NO CU', '', '', '', '', '', 'sgffgs', 'gsfsfggsf', 'gsfgfs', '563365@agfs', '6543634', '53356635', '3563565', '0065-05-31', '0356-05-31', '035635656'),
(33, 5, 10, 2, 2, 9, '', '675a54eee0c41.pdf', '', '', '', '', '698968', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0'),
(34, 5, 10, 3, 2, 9, 'gfdddddddddddddddd', '', '', '', '', '', '@afdsffds', '', '', '', '', '999', '999', '0000-00-00', '0000-00-00', '0');
...
(10, 'Teodoro', '122341', '6355536', '365365', 'adsd@A');
...
--
ALTER TABLE `estagios`
  MODIFY `id_estagio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `estagios`
  ADD CONSTRAINT `estagios_ibfk_1` FOREIGN KEY (`id_estudante`) REFERENCES `estudantes` (`id`),
  ADD CONSTRAINT `estagios_ibfk_2` FOREIGN KEY (`id_curso_estagio`) REFERENCES `cursos` (`id_curso`),
  ADD CONSTRAINT `estagios_ibfk_3` FOREIGN KEY (`id_professor_orientador`) REFERENCES `professores` (`id_professor`),
  ADD CONSTRAINT `estagios_ibfk_4` FOREIGN KEY (`id_professor_coorientador`) REFERENCES `professores` (`id_professor`),
  ADD CONSTRAINT `estagios_ibfk_5` FOREIGN KEY (`id_empresa_estagio`) REFERENCES `empresas` (`id_empresa`);
