...
ALTER TABLE `empresas`
  ...
  ADD KEY `cidade_id` (`cidade_empresa`);
...
--
ALTER TABLE `empresas`
  ADD CONSTRAINT `empresas_ibfk_1` FOREIGN KEY (`representante_empresa`) REFERENCES `representantes` (`id_representante`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `empresas_ibfk_2` FOREIGN KEY (`cidade_empresa`) REFERENCES `cidades` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `estagios`
--
ALTER TABLE `estagios`
  ADD CONSTRAINT `estagios_ibfk_1` FOREIGN KEY (`id_estudante`) REFERENCES `estudantes` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `estagios_ibfk_2` FOREIGN KEY (`id_curso_estagio`) REFERENCES `cursos` (`id_curso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `estagios_ibfk_3` FOREIGN KEY (`id_professor_orientador`) REFERENCES `professores` (`id_professor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `estagios_ibfk_4` FOREIGN KEY (`id_professor_coorientador`) REFERENCES `professores` (`id_professor`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `estagios_ibfk_5` FOREIGN KEY (`id_empresa_estagio`) REFERENCES `empresas` (`id_empresa`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Restrições para tabelas `estudantes`
--
ALTER TABLE `estudantes`
  ADD CONSTRAINT `estudantes_ibfk_1` FOREIGN KEY (`cidade_id`) REFERENCES `cidades` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
